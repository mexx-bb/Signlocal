...
function WindowsCompanionDownload() {
  return <section className="relative mx-auto mt-10 max-w-6xl px-5 pb-14 sm:px-8" aria-label="Installation für das lokale Unterschriftenpad"><div aria-hidden="true" className="absolute bottom-5 left-9 top-0 hidden w-px bg-[#b6c9bd]/55 sm:block"/><div className="relative max-w-2xl"><span aria-hidden="true" className="absolute -left-6 top-1 hidden h-3 w-3 rounded-full border-2 border-[#155e63] bg-[#fffdf8] sm:block"/><p className="text-xs font-bold uppercase tracking-[.14em] text-[#155e63]">Lokale Begleit-App</p><h2 className="display mt-2 text-3xl leading-tight text-[#183234]">Mobilgerät sicher als Unterschriftenpad nutzen</h2><p className="mt-3 text-sm leading-6 text-[#506967]">Wähle das Paket für deinen Computer. PDF und Unterschrift bleiben im eigenen Netzwerk; beide Installationen sind nur für ein <strong>privates WLAN</strong> oder einen eigenen Offline-Hotspot bestimmt.</p></div><div className="relative mt-5 grid gap-4 lg:grid-cols-2"><article className="paper-card rounded-[1.7rem] border border-[#155e63]/20 bg-[#f6f4ed] p-5 shadow-sm"><p className="text-xs font-bold uppercase tracking-[.14em] text-[#155e63]">Für Windows</p><h3 className="display mt-2 text-2xl text-[#183234]">Windows-Companion</h3><p className="mt-2 text-sm leading-6 text-[#506967]">Ein-Klick-Installation mit Desktop-Start, lokalem TLS-Zertifikat und Anleitung für das eigene WLAN.</p><a href={WINDOWS_COMPANION_INSTALLER} download="SignLocal-Windows-Companion-Installation.zip" className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#155e63] px-5 text-sm font-bold text-white shadow-md shadow-[#155e63]/20 transition hover:bg-[#0d4549] active:scale-[.97]"><Download size={18}/>Windows herunterladen</a></article><article className="paper-card rounded-[1.7rem] border border-[#155e63]/20 bg-[#eef6f2] p-5 shadow-sm"><p className="text-xs font-bold uppercase tracking-[.14em] text-[#155e63]">Für macOS</p><h3 className="display mt-2 text-2xl text-[#183234]">macOS-Companion</h3><p className="mt-2 text-sm leading-6 text-[#506967]">Eigener Doppelklick-Installer mit Desktop-Start und Anleitung für den Mac-Hotspot ohne Internet.</p><a href={MACOS_COMPANION_INSTALLER} download="SignLocal-macOS-Companion-Installation.zip" className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#155e63] px-5 text-sm font-bold text-white shadow-md shadow-[#155e63]/20 transition hover:bg-[#0d4549] active:scale-[.97]"><Download size={18}/>macOS-Installation herunterladen</a></article></div><CompanionSupport hotspotImage={MACOS_HOTSPOT_GUIDE_IMAGE}/></section>;
}
const INK_COLORS = [
