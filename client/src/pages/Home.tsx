...
const WINDOWS_COMPANION_INSTALLER = "/manus-storage/SignLocal-Windows-Companion-Installation_54a02533.zip";
...
function WindowsCompanionDownload() {
  return <section className="mx-auto mt-10 max-w-6xl px-5 pb-14 sm:px-8" aria-label="Windows-Installation für das lokale Unterschriftenpad"><div className="paper-card overflow-hidden rounded-[1.7rem] border border-[#102b79]/15 bg-[#f5faff] p-5 shadow-sm sm:p-7"><div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between"><div className="max-w-2xl"><p className="text-xs font-bold uppercase tracking-[.14em] text-[#102b79]">Windows-Begleit-App</p><h2 className="display mt-2 text-3xl leading-tight text-[#183234]">iPad oder iPhone als Unterschriftenpad nutzen</h2><p className="mt-3 text-sm leading-6 text-[#506967]">Das Ein-Klick-Paket richtet den lokalen Windows-Companion ein und erstellt einen Desktop-Start. PDF und Unterschrift bleiben im eigenen Netzwerk; das Paket ist nur für dasselbe <strong>private WLAN</strong> bestimmt.</p></div><a href={WINDOWS_COMPANION_INSTALLER} download="SignLocal-Windows-Companion-Installation.zip" className="inline-flex min-h-12 shrink-0 items-center justify-center gap-2 rounded-xl bg-[#102b79] px-5 text-sm font-bold text-white shadow-md shadow-[#102b79]/20 transition hover:bg-[#0b1f5c] active:scale-[.97]"><Download size={18}/>Windows-Installation herunterladen</a></div><p className="mt-5 rounded-xl border border-[#14d9e8]/30 bg-white/75 p-3 text-xs leading-5 text-[#506967]"><strong className="text-[#102b79]">Vor dem Start:</strong> Windows-PC und Mobilgerät müssen im selben privaten WLAN sein. Die Installation erstellt ein lokales Zertifikat und fordert bei Bedarf die Windows-Administratorbestätigung an. Gäste- und öffentliche WLANs werden bewusst nicht unterstützt.</p></div></section>;
}
const INK_COLORS = [
