...
const WINDOWS_COMPANION_INSTALLER = "/manus-storage/SignLocal-Windows-Companion-PortableHost_b7d92aa4.zip";
const MACOS_COMPANION_INSTALLER = "/manus-storage/SignLocal-macOS-Companion-PortableHost_0a42b7da.zip";
