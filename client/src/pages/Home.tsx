...
const HERO_IMAGE = `${STATIC_ASSET_BASE}assets/signlocal-hero.png`;
const ILLUSTRATION_IMAGE = `${STATIC_ASSET_BASE}assets/signlocal-mobile-illustration.png`;
const DETAIL_IMAGE = `${STATIC_ASSET_BASE}assets/signlocal-path-detail.png`;
const MARK_IMAGE = `${STATIC_ASSET_BASE}assets/signlocal-brand-mark.png`;
const WINDOWS_COMPANION_INSTALLER = `${STATIC_ASSET_BASE}downloads/SignLocal-Windows-Companion-PortableHost.zip`;
const MACOS_COMPANION_INSTALLER = `${STATIC_ASSET_BASE}downloads/SignLocal-macOS-Companion-PortableHost.zip`;
const MACOS_HOTSPOT_GUIDE_IMAGE = `${STATIC_ASSET_BASE}assets/signlocal-macos-hotspot-guide.png`;
