...
const MARK_IMAGE = "/manus-storage/signlocal-brand-mark_96c1547c.png";
const WINDOWS_COMPANION_INSTALLER = "/manus-storage/SignLocal-Windows-Companion-Installation_f0212a8a.zip";
const MACOS_COMPANION_INSTALLER = "/manus-storage/SignLocal-macOS-Companion-Installation_f3d6757a.zip";
const MACOS_HOTSPOT_GUIDE_IMAGE = "/manus-storage/signlocal-macos-hotspot-guide_0d054cc0.png";
...
function WindowsCompanionDownload() {
  return <section className="mx-auto mt-10 max-w-6xl px-5 pb-14 sm:px-8" aria-label="Installation für das lokale Unterschriftenpad"><div className="max-w-2xl"><p className="text-xs font-bold uppercase tracking-[.14em] text-[#102b79]">Lokale Begleit-App</p><h2 className="display mt-2 text-3xl leading-tight text-[#183234]">Mobilgerät sicher als Unterschriftenpad nutzen</h2><p className="mt-3 text-sm leading-6 text-[#506967]">Wähle das Paket für deinen Computer. PDF und Unterschrift bleiben im eigenen Netzwerk; beide Installationen sind nur für ein <strong>privates WLAN</strong> oder einen eigenen Offline-Hotspot bestimmt.</p></div><div className="mt-5 grid gap-4 lg:grid-cols-2"><article className="paper-card rounded-[1.7rem] border border-[#102b79]/15 bg-[#f5faff] p-5 shadow-sm"><p className="text-xs font-bold uppercase tracking-[.14em] text-[#102b79]">Für Windows</p><h3 className="display mt-2 text-2xl text-[#183234]">Windows-Companion</h3><p className="mt-2 text-sm leading-6 text-[#506967]">Ein-Klick-Installation mit Desktop-Start, lokalem TLS-Zertifikat und Anleitung für das eigene WLAN.</p><a href={WINDOWS_COMPANION_INSTALLER} download="SignLocal-Windows-Companion-Installation.zip" className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#102b79] px-5 text-sm font-bold text-white shadow-md shadow-[#102b79]/20 transition hover:bg-[#0b1f5c] active:scale-[.97]"><Download size={18}/>Windows herunterladen</a></article><article className="paper-card rounded-[1.7rem] border border-[#155e63]/20 bg-[#eef6f2] p-5 shadow-sm"><p className="text-xs font-bold uppercase tracking-[.14em] text-[#155e63]">Für macOS</p><h3 className="display mt-2 text-2xl text-[#183234]">macOS-Companion</h3><p className="mt-2 text-sm leading-6 text-[#506967]">Eigener Doppelklick-Installer mit Desktop-Start und Anleitung für den Mac-Hotspot ohne Internet.</p><a href={MACOS_COMPANION_INSTALLER} download="SignLocal-macOS-Companion-Installation.zip" className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#155e63] px-5 text-sm font-bold text-white shadow-md shadow-[#155e63]/20 transition hover:bg-[#0d4549] active:scale-[.97]"><Download size={18}/>macOS-Installation herunterladen</a></article></div><div className="paper-card mt-5 overflow-hidden rounded-[1.7rem] border border-[#a7b9a6]/55 bg-[#fffdf8] shadow-sm lg:grid lg:grid-cols-[.92fr_1.08fr]"><div className="min-h-56 bg-[#eef2e9]"><img src={MACOS_HOTSPOT_GUIDE_IMAGE} alt="Mac als lokaler Hotspot, verbunden mit iPhone und iPad" className="h-full min-h-56 w-full object-cover"/></div><div className="p-5 sm:p-7"><p className="text-xs font-bold uppercase tracking-[.14em] text-[#155e63]">Unterwegs ohne Internet</p><h3 className="display mt-2 text-3xl leading-tight text-[#183234]">Dein Laptop verbindet die Geräte direkt.</h3><ol className="mt-4 space-y-3"><li className="flex gap-3"><span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#155e63] text-xs font-bold text-white">1</span><p className="text-sm leading-6 text-[#506967]"><strong className="text-[#183234]">Eigenen Hotspot einschalten.</strong> Auf Windows „Mobiler Hotspot“, auf dem Mac „Internetfreigabe“ öffnen und ein eigenes Passwort setzen.</p></li><li className="flex gap-3"><span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#155e63] text-xs font-bold text-white">2</span><p className="text-sm leading-6 text-[#506967]"><strong className="text-[#183234]">iPhone oder iPad verbinden.</strong> Mit genau diesem eigenen Netzwerk verbinden – kein Gäste- oder öffentliches WLAN verwenden.</p></li><li className="flex gap-3"><span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#155e63] text-xs font-bold text-white">3</span><p className="text-sm leading-6 text-[#506967]"><strong className="text-[#183234]">Companion starten und koppeln.</strong> Den Desktop-Start öffnen, Zertifikat einrichten, QR-Code scannen und den sechsstelligen Code auf beiden Geräten bestätigen.</p></li></ol><p className="mt-5 rounded-xl border border-[#14d9e8]/30 bg-[#f5faff] p-3 text-xs leading-5 text-[#506967]"><strong className="text-[#102b79]">Einmalig nötig:</strong> Die Installation lädt mit Internet Node.js, mkcert und Companion-Dateien. Danach läuft die Signaturkopplung im eigenen lokalen Netz ohne Internet; PDFs und Unterschriften bleiben dort.</p></div></div></section>;
}
const INK_COLORS = [
  ...
  if (!file || !url) return (
    <main className="min-h-screen overflow-hidden">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-5 pb-7 pt-5 sm:px-8 sm:pt-7">
        <a href="/" className="brand-lockup flex items-center gap-3" aria-label="SignLocal Startseite"><span className="brand-lockup-mark"><img src={MARK_IMAGE} alt="" className="h-11 w-11 object-contain"/></span><span><span className="display block text-2xl font-bold tracking-tight text-[#102b79]">Sign<span className="text-[#334454]">Local</span></span><span className="brand-lockup-note">Dein Weg zum unterschriebenen PDF</span></span></a>
