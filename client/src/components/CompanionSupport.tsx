 ...
 */
import { Check, ShieldCheck, TriangleAlert, Wifi } from "lucide-react";
...
const faqs = [
  {
    ...
    answer: "Nur die erste Installation benötigt Internet, damit Node.js, mkcert und die Companion-Dateien eingerichtet werden. Danach können Laptop und Mobilgerät über den eigenen Laptop-/Mac-Hotspot oder einen privaten Reiserouter lokal miteinander verbunden werden.",
  },
  {
...
export function CompanionSupport({ hotspotImage }: CompanionSupportProps) {
  return <section className="paper-card relative mt-5 overflow-hidden rounded-[1.7rem] border border-[#a7b9a6]/55 bg-[#fffdf8] shadow-sm" aria-label="Hilfe für lokale Offline-Nutzung">
    <div aria-hidden="true" className="absolute bottom-0 left-7 top-0 w-px bg-[#b6c9bd]/55 sm:left-9"/>
    ...
    <Accordion type="single" collapsible className="relative px-5 pl-12 sm:px-7 sm:pl-16">
      <AccordionItem value="hotspot" className="border-[#d8d3c9]/70"><AccordionTrigger className="py-5 text-base font-bold text-[#183234] hover:no-underline"><span className="flex items-center gap-3"><span className="grid h-9 w-9 place-items-center rounded-xl bg-[#eef2e9] text-[#155e63]"><Wifi size={18}/></span>Offline-Hotspot einrichten</span></AccordionTrigger><AccordionContent className="pb-6"><div className="overflow-hidden rounded-2xl border border-[#a7b9a6]/45 bg-[#eef2e9]"><img src={hotspotImage} alt="Mac als lokaler Hotspot, verbunden mit iPhone und iPad" className="h-auto w-full object-cover"/></div><ol className="mt-4 space-y-3"><li className="flex gap-3"><span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#155e63] text-xs font-bold text-white">1</span><p className="text-sm leading-6 text-[#506967]"><strong className="text-[#183234]">Eigenen Hotspot einschalten.</strong> Auf Windows „Mobiler Hotspot“, auf dem Mac „Internetfreigabe“ öffnen und ein eigenes Passwort festlegen.</p></li><li className="flex gap-3"><span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#155e63] text-xs font-bold text-white">2</span><p className="text-sm leading-6 text-[#506967]"><strong className="text-[#183234]">Mobilgerät verbinden.</strong> iPhone, iPad oder Android mit diesem eigenen Netzwerk verbinden – nie mit Gäste- oder öffentlichem WLAN.</p></li><li className="flex gap-3"><span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#155e63] text-xs font-bold text-white">3</span><p className="text-sm leading-6 text-[#506967]"><strong className="text-[#183234]">Companion starten und koppeln.</strong> Desktop-Start öffnen, die lokale Zertifikatseinrichtung durchführen, QR-Code scannen und den sechsstelligen Code auf beiden Geräten vergleichen.</p></li></ol></AccordionContent></AccordionItem>
      <AccordionItem value="certificate" className="border-[#d8d3c9]/70"><AccordionTrigger className="py-5 text-base font-bold text-[#183234] hover:no-underline"><span className="flex items-center gap-3"><span className="grid h-9 w-9 place-items-center rounded-xl bg-[#fff0e8] text-[#9d4d2f]"><TriangleAlert size={18}/></span>Browser zeigt eine Zertifikatswarnung</span></AccordionTrigger><AccordionContent className="pb-6"><div className="rounded-2xl border border-[#f0bd9e] bg-[#fff6ef] p-4"><div className="flex items-start gap-3"><ShieldCheck className="mt-0.5 shrink-0 text-[#9d4d2f]" size={20}/><div><p className="font-bold text-[#183234]">Nicht auf „Trotzdem fortfahren“ tippen.</p><p className="mt-1 text-sm leading-6 text-[#506967]">Eine Warnung bedeutet, dass die lokale Vertrauenskette noch nicht stimmt. Prüfe zuerst, ob Computer und Mobilgerät im selben eigenen Netzwerk sind, und öffne dann die lokale CA-Einrichtungsseite erneut.</p></div></div></div><ol className="mt-4 space-y-2 text-sm leading-6 text-[#506967]"><li className="flex gap-2"><Check className="mt-1 shrink-0 text-[#155e63]" size={16}/>Den Companion auf dem Computer erneut starten.</li><li className="flex gap-2"><Check className="mt-1 shrink-0 text-[#155e63]" size={16}/>Auf dem Mobilgerät die angezeigte öffentliche CA installieren und den Fingerabdruck mit dem Computer vergleichen.</li><li className="flex gap-2"><Check className="mt-1 shrink-0 text-[#155e63]" size={16}/>Auf iPhone/iPad die volle Vertrauensfreigabe für das Zertifikat aktivieren; erst dann die lokale HTTPS-Adresse öffnen.</li></ol></AccordionContent></AccordionItem>
      <AccordionItem value="faq" className="border-0"><AccordionTrigger className="py-5 text-base font-bold text-[#183234] hover:no-underline"><span className="flex items-center gap-3"><span className="grid h-9 w-9 place-items-center rounded-xl bg-[#f5faff] text-[#102b79]"><span className="text-sm font-black">?</span></span>FAQ für Außendienstmitarbeitende</span></AccordionTrigger><AccordionContent className="pb-6"><Accordion type="single" collapsible className="rounded-2xl border border-[#d8d3c9]/70 bg-white/65 px-4"><>{faqs.map((faq) => <AccordionItem value={faq.question} key={faq.question} className="border-[#d8d3c9]/70"><AccordionTrigger className="py-4 text-sm font-bold text-[#183234] hover:no-underline">{faq.question}</AccordionTrigger><AccordionContent className="pb-4 text-sm leading-6 text-[#506967]">{faq.answer}</AccordionContent></AccordionItem>)}</></Accordion></AccordionContent></AccordionItem>
    </Accordion>
  </section>;
}
